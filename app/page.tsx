    ...
    <div className="min-h-screen bg-white text-black dark:bg-black dark:text-zinc-50">
      <header className="fixed inset-x-0 top-0 z-50 border-b border-black/5 bg-white/80 backdrop-blur dark:border-white/10 dark:bg-black/60">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
          ...
          <nav className="hidden items-center gap-3 text-sm font-medium sm:flex">
            <a href="#services" className="rounded-full border border-[var(--brand)] px-4 py-2 text-[var(--brand)] transition hover:bg-[var(--brand-50)]">Usluge</a>
            <a href="#coverage" className="rounded-full border border-[var(--brand)] px-4 py-2 text-[var(--brand)] transition hover:bg-[var(--brand-50)]">Industrije</a>
            <a href="#contact" className="rounded-full border border-[var(--brand)] px-4 py-2 text-[var(--brand)] transition hover:bg-[var(--brand-50)]">Kontakt</a>
            <a href="tel:+491639071541" className="rounded-full bg-[var(--brand)] px-4 py-2 text-white transition hover:opacity-90">Pozovi</a>
          </nav>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-6xl px-4">
        <section id="hero" className="pt-24 sm:pt-28">
          <div className="rounded-2xl border border-black/5 bg-[var(--brand-50)] p-6 shadow-sm dark:border-white/10 dark:bg-[var(--brand-100)] sm:p-10">
            <div className="flex min-h-[60svh] flex-col items-start justify-center gap-6">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <a href="tel:+491639071541" className="rounded-full bg-[var(--brand)] px-5 py-3 text-sm font-medium text-white transition hover:opacity-90">Pozovi odmah</a>
                <a href="#services" className="rounded-full border border-[var(--brand)] px-5 py-3 text-sm font-medium text-[var(--brand)] hover:bg-[var(--brand-50)]">Pogledaj usluge</a>
        ...
        <section id="services" className="scroll-mt-24 py-10">
          <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-zinc-900 sm:p-10">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-lg border border-black/10 p-5 dark:border-white/15">
                ...
                <div className="mt-4">
                <a href="#contact" className="inline-block rounded-full bg-[var(--brand)] px-4 py-2 text-xs font-medium text-white hover:opacity-90">Zatraži ponudu</a>
                </div>
              </div>
              <div className="rounded-lg border border-black/10 p-5 dark:border-white/15">
        ...
        <section id="coverage" className="scroll-mt-24 py-10">
          <div className="rounded-2xl border border-black/5 bg-[var(--brand-50)] p-6 shadow-sm dark:border-white/10 dark:bg-[var(--brand-100)] sm:p-10">
          ...
          <div className="rounded-2xl border border-black/5 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-zinc-900 sm:p-10">
            ...
            <form className="rounded-lg border border-black/10 p-5 dark:border-white/15">
              <div className="grid gap-3">
                <input className="rounded-md border border-black/10 bg-white px-3 py-2 text-sm outline-none placeholder:text-zinc-400 focus:border-[var(--brand)] dark:border-white/20 dark:bg-black" placeholder="Vaše ime" />
                <input className="rounded-md border border-black/10 bg-white px-3 py-2 text-sm outline-none placeholder:text-zinc-400 focus:border-[var(--brand)] dark:border-white/20 dark:bg-black" placeholder="Email" type="email" />
                <textarea className="min-h-28 rounded-md border border-black/10 bg-white px-3 py-2 text-sm outline-none placeholder:text-zinc-400 focus:border-[var(--brand)] dark:border-white/20 dark:bg-black" placeholder="Detalji projekta" />
                <button type="button" className="rounded-md bg-[var(--brand)] px-4 py-2 text-sm font-medium text-white hover:opacity-90">Pošalji</button>
              </div>
            </form>
            <div className="rounded-lg border border-black/10 p-5 text-sm dark:border-white/15">
              <div className="space-y-3">
                <div>
                  ...
                  <a href="tel:+491639071541" className="inline-block rounded-full border border-[var(--brand)] px-3 py-1 text-[var(--brand)] hover:bg-[var(--brand-50)]">+49 163 907 1541</a>
                </div>
                <div>
                  <div className="font-semibold">Email</div>
                  <a href="mailto:info@icode-marketing.com" className="inline-block rounded-full border border-[var(--brand)] px-3 py-1 text-[var(--brand)] hover:bg-[var(--brand-50)]">info@icode-marketing.com</a>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    <a className="inline-block rounded-full border border-[var(--brand)] px-3 py-1 text-[var(--brand)] hover:bg-[var(--brand-50)]" href="https://www.instagram.com/icode.marketing?igsh=MWVpMjZpY2tobmxnYQ==" target="_blank" rel="noopener noreferrer">Instagram</a>
                    <a className="inline-block rounded-full border border-[var(--brand)] px-3 py-1 text-[var(--brand)] hover:bg-[var(--brand-50)]" href="https://www.facebook.com/share/1A65FdQSPv/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer">Facebook</a>
                    <a className="inline-block rounded-full border border-[var(--brand)] px-3 py-1 text-[var(--brand)] hover:bg-[var(--brand-50)]" href="#" target="_blank" rel="noopener noreferrer">Messenger</a>
                  </div>
                </div>
              </div>
            </div>
